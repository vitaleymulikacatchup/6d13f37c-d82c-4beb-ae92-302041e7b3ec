...
export const metadata: Metadata = {
  title: "F1 Motors | Next Generation Performance Vehicles",
  description: "Experience Formula 1 racing technology on the road. Discover our latest high-performance vehicles engineered for speed, precision, and ultimate driving dynamics.",
  keywords: "F1 cars, performance vehicles, sports cars, racing technology, hybrid supercars",
  metadataBase: new URL("https://f1motors.com"),
  alternates: {
    canonical: "https://f1motors.com"
  },
  openGraph: {
    title: "F1 Motors | Next Generation Performance Vehicles",
    description: "Experience Formula 1 racing technology on the road. Discover our latest high-performance vehicles.",
    siteName: "F1 Motors",
    type: "website"
  },
  twitter: {
    ...
    title: "F1 Motors | Next Generation Performance Vehicles",
    description: "Experience Formula 1 racing technology on the road."
  }
};
